    ...
    protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame.Content == null)
            {
                ...
                // parameter
                rootFrame.Navigate(typeof(BrowserPage), e.Arguments);
            }
        ...
        protected override void OnActivated(IActivatedEventArgs args)
        {
            ...
            //                string navigationParameterString = string.Format("{0}|{1}|{2}",
            //                                voiceCommandName, textSpoken, destination);
            //                // Set the page where to navigate for this voice command
            //                //navigateToPageType = typeof(TripPage);
            //                var messageDialog = new Windows.UI.Popups.MessageDialog(navigationParameterString, "Text spoken");
            ...
            //                messageDialog = new Windows.UI.Popups.MessageDialog("Going to main page", "Text spoken");
            //                messageDialog.ShowAsync();
            //                break;
            //        }
            //    }
